...
export const DEFAULT_KEYWORDS = "MSSN, MSSNOAU, Muslim Students Society, Obafemi Awolowo University, OAU, Islamic organization, Students society, Nigerian Muslim students, Great Ife";
...
export const ORGANIZATION = {
    ...
    map: "https://maps.app.goo.gl/r4T4g5NCUW36dGeZ7",
    coordinates: {
        latitude: "7.5171491",
        longitude: "4.51768994109481"
    },
    socialMedia: {
        facebook: "https://facebook.com/mssnoau",
        twitter: "https://x.com/Mssngreatife1",
        instagram: "https://www.instagram.com/mssn_oau"
    }
}; 