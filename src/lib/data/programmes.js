export const programmes = [
        ...
        schedule: [
            {
                ...
                location: "Amphitheatre, White House"
            },
            {
                day: "Wednesdays",
                time: "4:00 PM - 6:00 PM",
    ...
    },
    {
        ...
        description: "<p>Deepen your understanding of Islam through our structured Madrasah classes, meticulously organized by the <strong>Islamic Affairs Board</strong>. Key features include:</p><ul><li><strong>Core Islamic Sciences:</strong> Courses in Tajweed (rules of Quranic recitation), basic to intermediate Arabic language, Fiqh (understanding Islamic jurisprudence for daily life), and Seerah (the life of Prophet Muhammad ﷺ).</li><li><strong>Qualified Instructors:</strong> Learn from knowledgeable and approachable teachers who simplify complex topics.</li><li><strong>Flexible Timings:</strong> Classes are often held on weekends or evenings to accommodate students' academic schedules.</li></ul>",
        schedule: [
            {
                day: "Saturdays",
                time: "2:00 PM - 5:00 PM",
                location: "MSSN OAU Secretariat/Madrasah Hall"
            },
            {
                day: "Sundays",
    ...
    },
    {
        ...
        description: "<p>Al-Usrah, meaning 'The Family', is our vibrant weekly Halaqah (study circle). It's a cornerstone of MSSN OAU, aiming to:</p><ul><li><strong>Foster Unity:</strong> Create a strong sense of community, brotherhood, and sisterhood among Muslim students.</li><li><strong>Discuss Relevant Issues:</strong> Address contemporary social, academic, and spiritual challenges from an Islamic viewpoint.</li><li><strong>Interactive Sessions:</strong> Typically involves a short insightful talk by a guest speaker or a knowledgeable member, followed by engaging Q&A and discussions.</li></ul>",
        schedule: [
            {
                day: "Fridays",
                time: "After Asr Prayer (approx. 4:30 PM)",
                location: "MSSN OAU Central Mosque Premises"
            }
        ]
    },
    {
        ...
        description: "<p>The Sisters' Circle provides a warm, confidential, and empowering space exclusively for our female members. This vital programme focuses on:</p><ul><li><strong>Spiritual Growth:</strong> Discussions on Quran, Hadith, and topics pertinent to a Muslimah's life and faith.</li><li><strong>Personal Development:</strong> Workshops and talks on self-improvement, health, relationships, and career development from an Islamic perspective.</li><li><strong>Sisterly Bonds:</strong> Activities designed to foster strong connections, mutual support, and lasting friendships.</li></ul>",
        schedule: [
            {
                day: "Thursdays",
                time: "5:00 PM - 6:30 PM",
                location: "Sisters' Common Room / Designated Hall"
            }
        ]
    }
]; 