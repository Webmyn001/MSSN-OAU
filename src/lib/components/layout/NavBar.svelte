                ...
                <a class="flex-none flex items-center gap-2 py-2" href="/" aria-label="MSSNOAU">
                    <div class="relative">
                        <img 
                          ...
                          width="240" 
                          height="45"
                          class="my-4 h-10 lg:h-12 w-auto max-w-[200px] lg:max-w-[240px] object-contain transition-transform hover:scale-105 duration-300" 
                          alt="mssnoau logo"
                          fetchpriority="high"
                          loading="eager" 
                        />
                ...
                >
                    <div class="flex flex-col gap-y-3 lg:gap-y-0 mt-5 lg:flex-row lg:items-center lg:justify-end lg:mt-0 lg:ps-5">
                        ...
                        <div class="relative" use:clickOutside={() => isDropdownOpen = false}>
                            ...
                            {#if isDropdownOpen}
                                <div
                                  class="absolute z-[52] right-0 mt-2 w-64 lg:w-auto bg-white shadow-xl border border-primary-100 rounded-xl py-2 px-2"
                                  transition:slide={{duration: 200, easing: cubicOut}}
                                  role="menu"
                                >
                                    <div class="lg:grid lg:grid-cols-3 lg:gap-2 lg:min-w-[600px]">
                                        <div class="flex flex-col">
                                            <a class="flex items-center py-2 px-3 rounded-xl text-sm font-primary text-gray-800 hover:bg-primary-50 hover:text-primary-700 transition-colors" href="/our-excos">
                                            ...
                                            <a class="flex items-center py-2 px-3 rounded-xl text-sm font-primary text-gray-800 hover:bg-primary-50 hover:text-primary-700 transition-colors" href="/our-advisors">
                                            ...
                                            <a class="flex items-center py-2 px-3 rounded-xl text-sm font-primary text-gray-800 hover:bg-primary-50 hover:text-primary-700 transition-colors" href="/alumnae">
                                        ...
                                        <div class="flex flex-col">
                                            <a class="flex items-center py-2 px-3 rounded-xl text-sm font-primary text-gray-800 hover:bg-primary-50 hover:text-primary-700 transition-colors" href="https://quiz.mssnoau.org">
                                            ...
                                            <a class="flex items-center py-2 px-3 rounded-xl text-sm font-primary text-gray-800 hover:bg-primary-50 hover:text-primary-700 transition-colors" href="https://library.mssnoau.org">
                                            ...
                                            <a class="flex items-center py-2 px-3 rounded-xl text-sm font-primary text-gray-800 hover:bg-primary-50 hover:text-primary-700 transition-colors" href="/annual-dues">
                                        ...
                                        <div class="flex flex-col">
                                            <a class="flex items-center py-2 px-3 rounded-xl text-sm font-primary text-gray-800 hover:bg-primary-50 hover:text-primary-700 transition-colors" href="/contact#faqs">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="size-4 me-2 text-primary-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
                                                FAQs
                                            </a>
                                            <a class="flex items-center py-2 px-3 rounded-xl text-sm font-primary text-gray-800 hover:bg-primary-50 hover:text-primary-700 transition-colors" href="/auth/login">
                                            ...
                                            <a class="flex items-center py-2 px-3 rounded-xl text-sm font-primary text-gray-800 hover:bg-primary-50 hover:text-primary-700 transition-colors" href="/auth/signup">
