<script>
    ...
    const central = [
        ...
        },
        {
            ...
            position: "N. Ameer - Islamic Affairs"
        },
        {
            name: "Hassan AbdulKabir",
            photo: "https://xsgames.co/randomusers/avatar.php?g=male",
            phone: "08173343673",
            gender: "Male",
            level: "400",
            department: "Quantity Surveying",
            position: "N. Ameer - Admin & Planning"
        },
        {
            name: "Nasir Abdul",
            photo: "https://xsgames.co/randomusers/avatar.php?g=male",
    ...
    const sessions = [
        {
            ...
            all: [
                {
                    label: "Central Executive Council Committee",
                    members: central
                },
                {
                    label: "An-Nur Press Agency Editorial Board",
                    members: an_nuur
                },
                {
                ...
                {
                    label: "ICT & Publicity Committee",
                    members: ict
                },
                {
                    label: "Mosque Cleaning Committee",
                    members: mosque
                },
                {
                    label: "Moro Committee",
                    members: moro
                },
                {
                    label: "Secondary School Committee",
                    members: secondary
                },
                {
                    label: "Asset Maintenance Committee",
                    members: assset
                }
            ]
        }
                                    ...
                                    <div class="mt-8">
                                        ...
                                        <ul class="mt-5 flex flex-col gap-y-3">
                                            ...
                                            <li class="flex items-center gap-x-2.5">
                                                ...
                                                <a class="text-[13px] text-gray-500 underline hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2 dark:text-neutral-500 dark:hover:text-neutral-400"
                                                   href={`https://wa.me/${member.phone.replace(/^0/, "").replace(/^234/, "").replace(/^\+234/, "")}`}
                                                >
                                                    {member.phone}
                                                </a>
                                            </li>
