    ...
    <div class="mt-12 aspect-video overflow-clip sm:mt-32 md:aspect-auto md:h-[420px]">
        <div class="relative mx-auto flex max-w-3xl flex-col">
            ...
            <div
                ...
                <img src="/images/man_3.jpg" alt="placeholder hero"
                     class="h-full w-full rounded-md object-cover object-center"/>
            </div>
            <div
                ...
                <img src="/images/woman-3.png" alt="placeholder hero"
                     class="h-full w-full rounded-md object-cover object-center"/>
            </div>
            <div
                ...
                <img src="/images/man_4.jpg" alt="placeholder hero"
                     class="h-full w-full rounded-md object-cover object-center"/>
            </div>
            <div
                ...
                <img src="/images/woman_4.jpg" alt="placeholder hero"
                     class="h-full w-full rounded-md object-cover object-center"/>
            </div>
            <div
                ...
                <img src="/images/man_5.jpg" alt="placeholder hero"
                     class="h-full w-full rounded-md object-cover object-center"/>
            </div>
            <div
                ...
                <img src="/images/woman_5.jpg" alt="placeholder hero"
                     class="h-full w-full rounded-md object-cover object-center"/>
            </div>
            <div
                ...
                <img src="/images/man_6.jpg" alt="placeholder hero"
                     class="h-full w-full rounded-md object-cover object-center"/>
            </div>
            <div
                ...
                <img src="/images/woman-6.jpg" alt="placeholder hero"
                     class="h-full w-full rounded-md object-cover object-center"/>
            </div>
            <div
                ...
                <img src="/images/man_7.jpg" alt="placeholder hero"
                     class="h-full w-full rounded-md object-cover object-center"/>
            </div>
            <div
                ...
                <img src="/images/woman_7.jpg" alt="placeholder hero"
                     class="h-full w-full rounded-md object-cover object-center"/>
            </div>
