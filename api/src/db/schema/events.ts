import { pgTable, pgEnum, uuid, varchar, text, decimal, integer, boolean, timestamp, index } from 'drizzle-orm/pg-core'
import { users } from './users.js'

// * Ticket status enum (must be defined before use)
export const ticketStatusEnum = pgEnum('ticket_status', ['PENDING', 'CONFIRMED', 'USED', 'CANCELLED'])
